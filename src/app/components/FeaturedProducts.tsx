...
export function FeaturedProducts({
  ...
  const featuredProducts = products.filter((p, i) => p.isFeatured && i < 4);
  const regularProducts = products.filter((p, i) => !p.isFeatured && i < 4);
    ...
    >
      ...
      <div className="p-5">
        ...
        <button
          ...
          className="w-full bg-[#16A34A] hover:bg-[#22C55E] disabled:bg-[#9CA3AF] text-white py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2"
        >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {isLoading ? (
          ...
          <div className="space-y-16">
            ...
            {/* OTHER / REGULAR PRODUCTS SECTION */}
            {regularProducts.length > 0 && (
              <div>
                <div className="text-center mb-10">
                  ...
                  <p className="text-[#6B7280] max-w-2xl mx-auto">
                    Explore our full catalogue of items
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
