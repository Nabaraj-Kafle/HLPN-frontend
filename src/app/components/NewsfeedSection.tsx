...
export function NewsfeedSection({
  ...
  const [selectedNewsfeed, setSelectedNewsfeed] = useState<NewsfeedItem | null>(
    null,
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-[#6B7280] max-w-2xl mx-auto">
            Stay informed with the latest happenings, community stories, and
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4 bg-white rounded-2xl border border-dashed border-[#CBD5E1]">
            ...
            <p className="text-[#64748B] text-center max-w-md">
              We don't have any updates to share at the moment. Please check
              back later for the latest news!
            </p>
          </div>
        ) : (
